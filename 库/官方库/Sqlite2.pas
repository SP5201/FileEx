...
type
  TSqlite3ExecCallback = function(Param: Pointer; NumCols: Integer; ColTextStrs: PPChar; ColNameStrs: PPChar): Integer; cdecl;

function sqlite3_exec(DbConnection: sqlite3; sql: PChar; Callback: TSqlite3ExecCallback; CallbackArg: Pointer; ErrMsg: PPChar): Integer; cdecl;
...
type
  ...
  sqlite3_vfs = record
    ...
    pAppData: Pointer;
    xOpen: function(Vfs: PSqlite3_vfs; zName: MarshaledAString; aFile: PSqlite3_file; flags: Integer; var OutFlags: Integer): Integer; cdecl;
...
function sqlite3_busy_handler(DbConnection: sqlite3; Callback: TSqlite3BusyHandlerCallback; Ptr: Pointer): Integer; cdecl;
...
function sqlite3_get_table(db: sqlite3; zSql: MarshaledAString; pazResult: PPPAnsiChar; var pnRow, pnColumn: Integer; pzErrmsg: PMarshaledAString): Integer; cdecl;
...
procedure sqlite3_progress_handler(DbConnection: sqlite3; N: Integer; Callback: TSqlite3ProgressHandlerCallback; P: Pointer); cdecl;
...
function sqlite3_prepare(db: sqlite3; zSql: MarshaledAString; nByte: Integer; out ppStmt: sqlite3_stmt; out pzTail: MarshaledAString): Integer; cdecl;
{$EXTERNALSYM sqlite3_prepare}

function sqlite3_prepare_v2(db: sqlite3; zSql: MarshaledAString; nByte: Integer; out ppStmt: sqlite3_stmt; out pzTail: MarshaledAString): Integer; cdecl;
{$EXTERNALSYM sqlite3_prepare_v2}

function sqlite3_prepare16(db: sqlite3; zSql: PChar; nByte: Integer; out ppStmt: sqlite3_stmt; out pzTail: PChar): Integer; cdecl;
{$EXTERNALSYM sqlite3_prepare16}

function sqlite3_prepare16_v2(db: sqlite3; zSql: PChar; nByte: Integer; out ppStmt: sqlite3_stmt; out pzTail: PChar): Integer; cdecl;
...
function sqlite3_bind_blob(Statement: sqlite3_stmt; Index: Integer; Value: Pointer; n: Integer; Proc: TBindDestructor): Integer; cdecl;
...
function sqlite3_bind_text(Statement: sqlite3_stmt; Index: Integer; Value: MarshaledAString; n: Integer; Proc: TBindDestructor): Integer; cdecl;
{$EXTERNALSYM sqlite3_bind_text}

function sqlite3_bind_text16(Statement: sqlite3_stmt; Index: Integer; Value: PChar; n: Integer; Proc: TBindDestructor): Integer; cdecl;
...
function sqlite3_create_function(db: sqlite3; zFunctionName: MarshaledAString; nArg, eTextRep: Integer; pApp: Pointer; xFunc: TxFunc; xStep: TxStep; xFinal: TxFinal): Integer; cdecl;
{$EXTERNALSYM sqlite3_create_function}

function sqlite3_create_function16(db: sqlite3; zFunctionName: PChar; nArg, eTextRep: Integer; pApp: Pointer; xFunc: TxFunc; xStep: TxStep; xFinal: TxFinal): Integer; cdecl;
{$EXTERNALSYM sqlite3_create_function16}

function sqlite3_create_function_v2(db: sqlite3; zFunctionName: MarshaledAString; nArg, eTextRep: Integer; pApp: Pointer; xFunc: TxFunc; xStep: TxStep; xFinal: TxFinal; xDestroy: TxDestroy): Integer; cdecl;
...
function sqlite3_create_collation(DbConnection: sqlite3; zName: MarshaledAString; eTextRep: Integer; pArg: Pointer; xCompare: TxCompare): Integer; cdecl;
{$EXTERNALSYM sqlite3_create_collation}

function sqlite3_create_collation_v2(DbConnection: sqlite3; zName: MarshaledAString; eTextRep: Integer; pArg: Pointer; xCompare: TxCompare; xDestroy: TxDestroy): Integer; cdecl;
{$EXTERNALSYM sqlite3_create_collation_v2}

function sqlite3_create_collation16(DbConnection: sqlite3; zName: PChar; eTextRep: Integer; pArg: Pointer; xCompare: TxCompare): Integer; cdecl;
...
function sqlite3_table_column_metadata(db: sqlite3; zDbName, zTableName, zColumnName: MarshaledAString; out pzDataType, pzCollSeq: MarshaledAString; out pNotNull, pPrimaryKey, pAutoinc: Integer): Integer; cdecl;
...
type
  ...
  sqlite3_module = record
    iVersion: Integer;
    xCreate: function(DbConnection: sqlite3; pAux: Pointer; argc: Integer; argv: Pointer; ppVTab: PPSqlite3_vtab; Str: PMarshaledAString): Integer; cdecl;
    xConnect: function(DbConnection: sqlite3; pAux: Pointer; argc: Integer; argv: Pointer; ppVTab: PPSqlite3_vtab; Str: PMarshaledAString): Integer; cdecl;
    ...
    xFilter: function(Cursor: PSqlite3_vtab_cursor; idxNum: Integer; idxStr: MarshaledAString; argc: Integer; argv: PSqlite3_value): Integer; cdecl;
    ...
    xFindFunction: function(pVTab: PSqlite3_vtab; nArg: Integer; zName: MarshaledAString; var xFunc: TModulexFunc; ppArg: Pointer): Integer; cdecl;
...
function sqlite3_create_module_v2(db: sqlite3; zName: MarshaledAString; p: PSqlite3_module; pClientData: Pointer; Proc: TxDestroy): Integer; cdecl;
...
function sqlite3_blob_open(DbConnection: sqlite3; zDb, zTable, zColumn: MarshaledAString; iRow: sqlite3_int64; flags: Integer; ppBlob: Pointer): Integer; cdecl;
...
function sqlite3_wal_checkpoint_v2(db: sqlite3; zDb: MarshaledAString; eMode: Integer; out pnLog, pnCkpt: Integer): Integer; cdecl;
